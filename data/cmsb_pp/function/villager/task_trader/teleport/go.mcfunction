execute if entity @s[tag=r1] run function cmsb_pp:villager/task_trader/teleport/tp {tag:"r1"}
execute if entity @s[tag=r2] run function cmsb_pp:villager/task_trader/teleport/tp {tag:"r2"}
execute if entity @s[tag=g1] run function cmsb_pp:villager/task_trader/teleport/tp {tag:"g1"}

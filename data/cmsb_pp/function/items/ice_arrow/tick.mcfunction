...
fill ~ ~-1 ~ ~ ~-1 ~ ice
fill ~ ~-1 ~-1 ~ ~-1 ~1 repeating_command_block{Command:"function cmsb_pp:items/ice_arrow/set_ice {life:100}",auto:1b,conditionMet:1b,id:"minecraft:command_block",powered:0b} keep
fill ~-1 ~-1 ~ ~1 ~-1 ~ repeating_command_block{Command:"function cmsb_pp:items/ice_arrow/set_ice {life:100}",auto:1b,conditionMet:1b,id:"minecraft:command_block",powered:0b} keep
kill @s